...
__time_definitions = [
	[ ('1800', ON), ('2000', OFF)],
	[ ('2219', ON), ('2222', OFF)],
	[ ('1100', ON), ('1400', OFF), ('1700', ON), ('2000', OFF)],
	[ ('0600', ON), ('1000', OFF), ('1700', ON), ('2200', OFF)],
	[ ('0000', ON), ('$SUNRISE + 0100', OFF), ('$SUNSET - 0100', ON)]
]
...
__config = {
	'00:15:61:ee:bb:d2': TimerConfig('Donkey', {'Tue':__time_definitions[0], 'Thu':__time_definitions[1]}),
	'00:15:61:cc:85:e6': TimerConfig('Frog', {'Tue':__time_definitions[1]}),
	'00:15:61:cc:81:71': TimerConfig('Llama', {'Fri': [('1830', ON), ('2000', OFF)]})
}
